...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mToDoLists = Sublist.getInstance().getToDoLists();
                ...
                createNewList.setView(inflater.inflate(R.layout.alert_dialog_list_title, null))
                        .setPositiveButton("create", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Sublist.getInstance().addToDoList(title.getText().toString());
                                Intent intent = new Intent(MainActivity.this, ListActivity.class);
                                intent.putExtra("ListPosition", Sublist.getInstance().getToDoLists().size()-1);
                                toDoListRecycler.getAdapter().notifyItemInserted(Sublist.getInstance().getToDoLists().size()-1);
